...
import edit from '@/assets/icon/wx/fun/edit.png'
import appltai from '@/assets/icon/wx/fun/appltai.png'
...
// 0是无效菜单
const type = [
  // {id: 1, title: '进出记录', type: 2, img: SearchImg, feeValue: 0, tip: '查看进出记录'},
  ...
  {id: 12, title: '请假申请', type: 1, img: appltai, feeValue: 0, tip: '用于申请请假'},
  {id: 13, title: '请假列表', type: 1, img: edit, feeValue: 0, tip: '用于查看请假列表'},

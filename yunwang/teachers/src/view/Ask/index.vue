...
<script>
import {NavBar, Field, DatetimePicker, Popup, Toast, Picker, Button, Tag, Divider, Checkbox, CheckboxGroup, Notify, Cell, CellGroup} from 'vant'
import { timeFormatter } from '@/utils/formatter.js'
import { httpPost } from '@/utils/restful'
import { listApproveUser, insert } from '@/api/url'
import { getDepInfo, getFaceInfo } from '@/utils/userInfo.js'
  ...
  methods: {
    ...
    submitApplication () {
      ...
      httpPost(insert, {
        ...
        aiUserId: getFaceInfo().wxUserId, // 用户id 发布时修改 this.userInfo.id

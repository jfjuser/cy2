  ...
  <div>
    <group title="申请信息">
      ...
      <template v-if="addrType == 0">
        <x-input style="font-size:.875rem;" title="班级" :max="64" required placeholder-align="right"  text-align="right" v-model="form.addr" placeholder="请输入楼栋号/房号" :show-clear="false"></x-input>
      </template>
      ...
      <x-number style="font-size:.875rem;" :min="1" :max="999" :fillable="true" title="班级人数" required placeholder-align="right"  text-align="right" v-model="form.userNum" placeholder="请输入家庭人数"></x-number>
    </group>

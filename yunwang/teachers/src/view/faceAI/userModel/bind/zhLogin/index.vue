...
<script>
import { getDepInfo, getWxInfo, setUserInfo, getUserInfo } from '@/utils/userInfo.js'
...
export default {
  ...
  methods: {
    ...
    sendLogin () {
      ...
      if (getUserInfo()) {
        this.$router.replace({path: '/faceAI/userModel/bind/addUser/', query: {id: getUserInfo().id, depId: getDepInfo().departmentId, obj: getUserInfo(), type: 0}})
      }

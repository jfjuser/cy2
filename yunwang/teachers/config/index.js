...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/api': {
        // target: 'http://192.168.0.136:9000', // 设置调用接口域名和端口号别忘了加http
        ...
        // target: 'http://cy.40mi.com/', // 新的车场域名地址
        // target: 'http://cy2.40mi.com/', // 新的车场域名地址
        changeOrigin: true,
        pathRewrite: {
  ...
  build: {
    ...
    index: path.resolve(__dirname, '../yunwang/index.html'),

    // Paths
    assetsRoot: path.resolve(__dirname, '../yunwang'),
    assetsSubDirectory: 'static',
    assetsPublicPath: '/yunwang/',

  ...
  methods: {
    ...
    workCreate () {
      ...
      if (this.workDay !== '休息') {
        ...
        if (this.workId === 0) {
          ...
          this.shezhi = this.workDay
          this.getWorkShiftRow()
          // console.log(this.workDay, this.workDayData)
          if (this.workDay === -1) {
            this.workDayInfo = '休息'
          } else {
          ...
          if (this.workDay === -1) {
            ...
            this.workDayData[this.workId - 1].workTimeAt = '休息'
          } else {
            this.workDayData[this.workId - 1].value = this.workDay
    ...
    selectAll (value) {
      if (value.length === 0) {
        ...
        // 一键设置
        // console.log(this.workDay, this.workDayInfo, this.workDayData)
        // console.log(this.shezhi)
        this.workDay = this.shezhi
        for (let i = 0; i < this.workDayData.length; i++) {
          this.workDayData[i].value = this.workDay
          this.workDayData[i].workTimeAt = this.workDayInfo
        }

<template>
  <div class="app-container">
    <div class="table-main">
      ...
      <el-table style="width: 100%" max-height="600" :data="tableData" v-loading.body="listLoading" @selection-change="handleSelectionChange" element-loading-text="加载中..." border fit highlight-current-row>
...
<script>
import { timeFormatter, HHssFormatter, NumToTimeFormatter, NumToHHssFormatter } from '@/utils/formatter.js'
...
import { shiftsText } from '@/utils/helptext'
...
export default {
  ...
  mounted () {
    if (!Storage.get('shiftsShowHelp')) {
      this.$nextTick(() => {
        this.$alert(shiftsText, '帮助说明', {

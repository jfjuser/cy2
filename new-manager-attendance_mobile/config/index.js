...
module.exports = {
  dev: {
    ...
    proxyTable: {
      "/api": {
        ...
        // target: 'http://47.106.35.188', // 新的测试服IP地址
        // target: "http://cy.40mi.com", // 新的人脸域名地址
        // target: 'http://192.168.0.153:9000',
        // target: "http://192.168.0.227:9000", // 张哥本地服务器
        changeOrigin: true,
        pathRewrite: {
          "^/api": "/"
  ...
  build: {
    ...
    assetsSubDirectory: "static",
    assetsPublicPath: "/attendance/manager/",

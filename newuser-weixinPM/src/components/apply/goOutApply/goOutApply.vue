<template>
  <div class="warp-content">
    ...
    <div class="ast" style="margin-top:1.5rem">
      <Field  disabled required v-model="beginTime" @click="showTime" input-align="right" right-icon="arrow" label="外出开始时间" placeholder="请选择时间" />
    </div>
...
<!-- 外出结束时间 -->
    <div class="ast" style="margin-top:1.5rem">
      <Field  disabled required v-model="endTime" @click="showEndTime" input-align="right" right-icon="arrow" label="外出结束时间" placeholder="请选择时间" />
    </div>
    ...
    <!-- 外出地点 -->
    <van-field  style="margin-top:1rem" v-model="businessTrip" label="外出地点" placeholder="请输入外出地点" />
<!-- 外出事由 -->

  ...
  <div class="theme-face-home">
    <div class="other-body">
      <div class="other-name">
        ...
        <div @click="handleSwitch()">{{depInfo.departmentName !== undefined ? depInfo.departmentName : '请选择部门'}}</div>
      </div>
      <div v-transfer-dom>
        <popup v-model="showSwitch">
          <div class="switch-body">
            ...
            <div class="switch-tip">请选择切换的部门:</div>
            <search
              class="switch-search"
    ...
    <cell title="物业通知" :border-intent="false" v-if="list.length != 0">
      <marquee>
...
export default {
  ...
  methods: {
    ...
    filterTip (id) {
      let arr = [1, 0, 3, 4, 5, 6, 7, 8, 9, 10, 11]
    ...
    handleClickFun (info) {
      if (info) {
        ...
        switch (info.id) {
          case 1:
            // 记录查询
            this.$router.push({path: '/faceAI/search/'})
            break
          case 2:
            // 个人信息

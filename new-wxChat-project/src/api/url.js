 ...
 * @Last Modified time: 2020-11-25 14:47:26
*/
...
/** ********  【 新增用户管理API 】  **********/
export const loginByPhone = 'v1/aiDuyCompany/loginByPhone'
...
export const advSearchMsg = '/v1/push/adv/advSearchMsg'
export const selectCurrentAdv = '/v1/push/adv/selectCurrentAdv'
export const addAdvClickTimes = '/v1/push/adv/addAdvClickTimes/'

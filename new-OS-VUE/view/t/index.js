var vm = new Vue({
  ...
  data() {
    return {
      ...
      /**********  【 新修改 】  **********/
      host: "http://cy2.40mi.com/",
      // host: 'http://192.168.0.161:9000',
      isActive: true,
      code: "",
      type: "",
      plate: "",
  ...
  methods: {
    ...
    getNewCode () {
      axios({
        url: this.host + "pv/v1/ticket/refreshDynamicQrcode",
        method: "GET",
        params: {
          code: this.code
        }
      ...
      .catch(() => {
        this.$message.error('请重新扫描二维码')
      })
    },
    // 获取车场信息
    getInfo() {
      axios({
          url: this.host + "pv/v1/ticket/bingding/info",
          method: "GET",
          params: {
            code: this.code,
            type: this.type

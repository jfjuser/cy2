...
module.exports = {
  ...
  dev: {
    ...
    proxyTable: {
      '/api': {
        // aaa
        // target: 'http://192.168.0.200:9000', // 设置调用接口域名和端口号别忘了加http
        // target: 'https://beta.cytingchechang.com', // 设置调用接口域名和端口号别忘了加http/
        // target: 'http://cyai.cytingchechang.com/', // 原生人脸域名
        // target: 'https://www.cytingchechang.com', // 原生车场域名 168
        // target: 'http://cyai.cytingchechang.com/', // 原生人脸域名
        // target: 'https://www.cytingchechang.com', // 原生车场域名
        // target: 'http://47.106.35.188', // 新的测试IP
        // target: 'http://cy.40mi.com', // 新的人脸域名
        // target: 'http://cy2.40mi.com', // 新的车场域名
        // target: 'http://120.25.152.27', // 新的人脸IP
        // target: 'http://112.74.50.105/', // 新的车场IP
        // target: 'http://192.168.0.124:9000',
        target: 'http://192.168.0.88:9000',
        changeOrigin: true,
        pathRewrite: {

...
import { getTask, Task } from '@/api/url'
...
export default {
  ...
  methods: {
    ...
    fetchData () {
      let self = this
      self.listQuery = Object.assign(this.listQuery, { id: this.id })
      httpGet(getTask, self.listQuery).then(res => {
    ...
    createData () {
      this.$refs.dataform.validate((valid) => {
        if (valid) {
          this.form = Object.assign(this.form, { departmentTypeId: this.id })

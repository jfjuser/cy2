                ...
                <div class="inner">
                    ...
                    <div class="content" style="display: block;">
                        ...
                        <div class="marquee-view">
                            <div class="marquee">
                                <div class="row" v-for="(item,index) in marqueeData" :key="index">
                                    <span class="col">{{item.time}}</span>
                                    <span class="col">{{item.msg}}</span>
                                    <span class="col">{{item.errType}}</span>
...
export default {
  ...
  data () {
    return {
      ...
      // overviewData 概览数据
      overviewData: [
        { title: '设备总数', color: '#006cff', total: '2,190' },
        { title: '设备总数', color: '#6acca3', total: '190' },
        { title: '设备总数', color: '#6acca3', total: '3,001' },
        { title: '设备总数', color: '#ed3f35', total: '108' }
      ],
      // marquee 监控数据
      marqueeData: [
        {
          time: '20190710',
          msg: '北京市昌平区建材城西路金燕龙写字楼',
          errType: '1000002'
        },
        {
          time: '20190710',
      ...
      // provinceData 各省热销
      provinceData: [
        {title: '北京', count: '25,179'},
        {title: '河北', count: '25,179'},
        {title: '上海', count: '25,179'},
        {title: '江苏', count: '25,179'},
        {title: '山东', count: '25,179'}
      ]
    }
  },
  mounted () {
    // 调用 echarts 配置， 需操作 DOM
...
#echarts {
  min-height: 100%;
  background-color: $echartsColor;
}
</style>
<style lang='scss' scoped>
@import url("../../../assets/iconfont/echarts/icomoon.css"); // 引入依赖字体
body {
  line-height: 1.15;
  font-size: 0.5rem;
  margin: 0;
...
.viewport {
  ...
  min-height: 780px;
  margin: 0 auto;
  background: url("~@/assets/images/echarts/logo.png") no-repeat 0 0 / contain;
  display: flex;
...
.panel {
  ...
  border-image: url("~@/assets/images/echarts/border.png") 51 38 21 132;
...
.point .data {
  ...
  box-sizing: border-box;
  background-image: url("~@/assets/images/echarts/rect.png");

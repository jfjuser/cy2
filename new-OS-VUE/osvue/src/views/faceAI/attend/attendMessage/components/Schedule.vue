<template>
  <div >
    <div class="table-main">
      ...
      <el-table stripe  @cell-click="cellClick" :header-cell-style="{background:'#f3f4f6'}" style="width: 100%;" size="mini" max-height="600" :data="tableData" v-loading.body="listLoading" element-loading-text="加载中..." border fit highlight-current-row>
